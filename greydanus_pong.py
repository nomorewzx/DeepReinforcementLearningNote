...
# by greydanus: https://gist.github.com/greydanus/5036f784eec2036252e1990da21eda18
import numpy as np
import gym
...
while True:
    ...
    if done:
        ...
        _, loss_train, tf_grads_train, epr_train = sess.run([train_op, loss, tf_grads, tf_discounted_epr], feed)
